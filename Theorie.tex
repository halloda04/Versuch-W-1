...
c_{mol} = \frac{f}{2}R
\end{equation}
Für Komplexere Verbindungen besagt die Kopp-Neumann Regel, dass die molare Wärmekapazität der ganzen Verbindung die Summe aus den Wärmekapazitäten der einzelnen Atome innerhalb der Verbindung ist. Diese Regelung trifft nicht vollständig zu und ist somit nur eine Näherung an die Wärmekapazität. Diese Regel stimmt vorallem bei sehr niedrigen Temperaturen nicht.
