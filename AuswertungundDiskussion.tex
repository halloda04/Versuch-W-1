...
Der Wasserwert $\omega$ wird durch die Formel \ref{Wasserwert}
...
Daraus ergibt sich nun der Wasserwert des Dewar-Gefäßes für das $\SI{60}{\degreeCelsius}$ warme Wasser aus Gleichung \ref{Wasserwert} und \ref{Fehlerwasserwert}:
\begin{equation}
